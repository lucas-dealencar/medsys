...
- `pacientes`: CPF (único), nome
- `medicos`: CRM (único), especialidade
- `consultas`: pacienteId+dataHora, medicoId+dataHora, status
- `pagamentos`: consultaId, dataPagamento, status
- `prontuarios`: pacienteId+data, consultaId
- `especialidades`: nome (único)

## 📄 Licença

Este projeto é um sistema de exemplo para fins educacionais e de demonstração.
